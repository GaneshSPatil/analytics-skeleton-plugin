...
import static com.example.analytics.Request.REQUEST_STAGE_STATUS;
...
public class NotificationInterestedInExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() throws Exception {
        ...
        JsonArray analyticss = new JsonArray();
        analyticss.add(REQUEST_STAGE_STATUS.requestName());
        jsonObject.add("analyticss", analyticss);
