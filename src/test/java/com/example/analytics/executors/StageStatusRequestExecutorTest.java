...
public class StageStatusRequestExecutorTest {
    ...
    @Test
    public void shouldRenderASuccessResponseIfAnalyticsWasSent() throws Exception {
    ...
    @Test
    public void shouldRenderAnErrorResponseIfAnalyticsWasNotSent() throws Exception {
        GoPluginApiResponse response = new StageStatusRequestExecutor(null, null) {
            @Override
            protected void sendAnalytics() {
